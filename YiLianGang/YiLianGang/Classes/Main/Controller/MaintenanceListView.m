...
- (void)StartRefresh
{
    ...
    [(MaintenanceListViewController *)[self GetSubordinateControllerForSelf] refreshData];
}
...
{
    MaintenanceListViewController*vc = (MaintenanceListViewController *)[self GetSubordinateControllerForSelf];
    [vc gotoContentControllerWith:mArray[indexPath.row]];
}
